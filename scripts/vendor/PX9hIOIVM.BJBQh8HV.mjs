...
e(() => {
  (d(),
    ...
    (q = ce(oe(C(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (J = `framer-6jWyo`),
        ...
        let { style: l, className: d, layoutId: f, variant: te, ...m } = xe(e),
          {
            ...
            setVariant: ce,
            variants: x,
          } = ae({ defaultVariant: `HK2sXlagE`, ref: i, variant: te, variantClassNames: Y }),
          S = Se(e, x),
          C = g(J);
        return s(ne, {
          id: f ?? a,
...
//# sourceMappingURL=PX9hIOIVM.BJBQh8HV.mjs.map
