...
function We(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(Sc)?.length || 0) + (e.match(Fc)?.length || 0) > 0
  );
}
function Ge(e) {
  let t = e.toString(),
      ...
      .replace(
        ...
        (e) => (
          G.test(e)
            ...
            : e.startsWith(zc)
              ? (r.var.push(a), i.push(Rc), n.push(e))
              : (r.number.push(a), i.push(Ic), n.push(parseFloat(e))),
          ++a,
          Bc
        )
      )
...
function qe({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Ic ? (i += xc(r[a])) : e === Lc ? (i += G.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function Ye(e) {
  let t = Ge(e);
  return qe(t)(t.values.map((e, n) => Uc(e, t.split[n])));
}
function Xe(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function mt(e = J.visualDuration, t = J.bounce) {
  ...
  let ee = {
    ...
    toString: () => {
      let e = Math.min(st(ee), Zc),
        t = Xc((t) => ee.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function _t(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = Rs(Array.isArray(t) ? t[n] || F : t, a)), r.push(a));
  }
  return r;
}
...
function Tt(e) {
  typeof e.type == `string` && (e.type = al[e.type]);
}
function Et(e) {
  return new cl(e);
}
...
function Mt() {
  if (Tl) {
    let e = Array.from(Cl).filter((e) => e.needsMeasurement),
  ...
  ((Tl = !1), (wl = !1), Cl.forEach((e) => e.complete(El)), Cl.clear());
}
function Nt() {
  Cl.forEach((e) => {
...
function Bt({ type: e, ...t }) {
  return zt(e) && Ml() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Vt(e) {
  return e in Il;
}
function Ht(e) {
  typeof e.ease == `string` && Vt(e.ease) && (e.ease = Il[e.ease]);
}
function Ut(e) {
  ((e.duration = 0), (e.type = `keyframes`));
}
function Wt(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == `string` && Bl.test(e[t])) return !0;
  return !1;
}
function Gt(e) {
  let {
...
function pn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(iu(t, r, i, h && ou.has(t) ? { type: !1 } : o, e, m));
    let g = r.animation;
    g && d.push(g);
  }
  if (o) {
...
function vn(e, t) {
  let n = xu(e);
  return (Su.has(n) || (n = K), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function yn(e) {
  return typeof e == `number` ? e === 0 : e === null || e === `none` || e === `0` || Ls(e);
}
function bn(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Cu.has(t) && Ge(t).values.length && (i = e[r]), r++);
  }
...
function Sn(e) {
  return Is(e) && `offsetHeight` in e && !(`ownerSVGElement` in e);
}
function Cn() {
  return Z.x || Z.y;
}
...
function Nn(e, t, n = {}) {
  let [r, i, a] = Tn(e, n),
    o = (e) => {
      ...
      if (!Mn(e) || Fu.has(e)) return;
      (Nu.add(r), n.stopPropagation && Fu.add(e));
      let a = t(r, e),
        o = { ...i, capture: !0 },
        s = (e, t) => {
          (f.removeEventListener(`pointerup`, c, o),
            f.removeEventListener(`pointercancel`, l, o),
            Nu.has(r) && Nu.delete(r),
            Mn(e) && typeof a == `function` && a(e, { success: t }));
        },
        c = (e) => {
          s(e, r === f || r === document || n.useGlobalTarget || ku(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
  ...
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? f : e).addEventListener(`pointerdown`, o, i),
        Sn(e) &&
          (e.addEventListener(`focus`, (e) => Pu(e, i)),
...
function Pn(e) {
  return Is(e) && `ownerSVGElement` in e;
}
...
function Ln() {
  typeof ResizeObserver > `u` || (Lu = new ResizeObserver(In));
}
function Rn(e, t) {
  Lu || Ln();
  let n = xn(e);
  return (
    n.forEach((e) => {
      let n = Iu.get(e);
      (n || ((n = new Set()), Iu.set(e, n)), n.add(t), Lu?.observe(e));
    }),
    () => {
      n.forEach((e) => {
        let n = Iu.get(e);
        (n?.delete(t), n?.size || Lu?.unobserve(e));
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      (Vu.delete(e),
        !Vu.size &&
          typeof Hu == `function` &&
          (f.removeEventListener(`resize`, Hu), (Hu = void 0)));
    }
  );
}
function Vn(e, t) {
...
function er(e) {
  return Qn(e.animate) || Zu.some((t) => $n(e[t]));
}
function tr(e) {
...
function vr(e, t, n, r = !1) {
  ...
  (t.x < sd && t.x > od && (t.x = 1), t.y < sd && t.y > od && (t.y = 1));
}
function O(e, t) {
  ((e.min += t), (e.max += t));
}
...
function wr(e, t, n) {
  ...
  return (
    a && ((i = !1), (r += `rotate(${Eu(a, hu.pathRotation)}) `)),
    (r = r.trim()),
...
function Or(e) {
  for (let t in e) ((fd[t] = e[t]), mc(t) && (fd[t].isCSSVariable = !0));
}
function kr(e, { layout: t, layoutId: n }) {
  return (
    yl.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!fd[e] || e === `opacity`))
  );
}
function Ar(e, t, n) {
  let r = e.style,
...
function Pr(
  ...
  for (let e of _d) d[e] !== void 0 && ((f[e] = d[e]), delete d[e]);
  (t !== void 0 && (d.x = t),
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
...
function Fr(e, t, n, r) {
  Er(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(vd.has(n) ? n : un(n), t.attrs[n]);
}
function Ir(e, t, n) {
  let r = Ar(e, t, n);
  for (let n in e)
    if (X(e[n]) || X(t[n])) {
      let t = vl.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
      r[t] = e[n];
    }
  return r;
}
...
function qr(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.translate >= Od && e.translate <= kd) || isNaN(e.translate)) && (e.translate = 0));
}
function Jr(e, t, n, r) {
...
function ni(e, t, n, r) {
  (ti(e.x, t, Ad, n ? n.x : void 0, r ? r.x : void 0),
    ti(e.y, t, jd, n ? n.y : void 0, r ? r.y : void 0));
}
function ri(e) {
...
function fi(e, t, n, r, i, a) {
  i
    ? ((e.opacity = q(0, n.opacity ?? 1, Fd(r))), (e.opacityExit = q(t.opacity ?? 1, 0, Id(r))))
  ...
  for (let i = 0; i < Md; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || Pd(o) === Pd(s)
        ? ((e[a] = Math.max(q(Nd(o), Nd(s), r), 0)), (U.test(s) || U.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Wd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            Uu.value && (Vd.nodes = Vd.calculatedTargetDeltas = Vd.calculatedProjections = 0),
            this.nodes.forEach(wi),
            this.nodes.forEach(Ni),
            this.nodes.forEach(Pi),
            this.nodes.forEach(Ti),
            Uu.addProjectionMetrics && Uu.addProjectionMetrics(Vd));
        }),
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Bd.hasAnimatedSinceResize &&
                ((Bd.hasAnimatedSinceResize = !1), this.nodes.forEach(Mi)));
          }));
      }
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          Uu.value && Vd.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        Uu.value && Vd.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = qu()),
        (this.projectionDelta = qu()),
        (this.projectionDeltaWithTransform = qu()));
    }
    ...
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new zd()),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Hd.length; t++)
        (yi(`rotate${Hd[t]}`, e, r, this.animationValues),
          yi(`skew${Hd[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      for (let t in fd) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = fd[t],
...
function ta() {
  if (lf) return;
  let e = {};
  for (let t in cf) e[t] = { isEnabled: (e) => cf[t].some((t) => !!e[t]) };
  (ir(e), (lf = !0));
}
function na() {
  return (ta(), ar());
...
function aa(e) {
  typeof e == `function` && (df = (t) => (t.startsWith(`on`) ? !ia(t) : e(t)));
}
function oa(e, t, n) {
  let r = {};
  for (let i in e)
...
function da(e) {
  let { initial: t, animate: r } = ua(e, y(ff));
...
function _a(e, t, r, i) {
  let a = n(() => {
    let n = gf();
    return (Pr(n, t, yd(i), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function va(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(_f.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
...
function $a(e) {
  let [t, n] = Zi(),
    r = y(js);
  return m(Rf, { ...e, layoutGroup: r, switchLayoutGroup: y(mf), isPresent: t, safeToRemove: n });
}
function eo(e, t, n) {
  let { props: r } = e;
...
function no({ root: e, ...t }) {
  ...
  let r = Wf.get(n),
    i = JSON.stringify(t);
  return (r[i] || (r[i] = new IntersectionObserver(Kf, { root: e, ...t })), r[i]);
}
function ro(e, t, n) {
  let r = no(t);
  return (
...
function ao(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > $f ? 0 : Vs(i.current - s, l);
}
function oo(e, t, n) {
...
function co(e, t, n = 0) {
  let r = 0;
  if ((e in rp && (e = rp[e]), typeof e == `string`)) {
    let t = parseFloat(e);
    e.endsWith(`px`)
      ? (r = t)
      : e.endsWith(`%`)
...
function lo(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ? (i = [e, e])
      : typeof e == `string` &&
        ((e = e.trim()), (i = e.includes(` `) ? e.split(` `) : [e, rp[e] ? e : `0`])),
    (a = co(i[0], n, r)),
    (o = co(i[1], t)),
    a - o
  );
...
function ho(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !sp.has(t))) {
    ...
    (f.addEventListener(`resize`, r),
      t !== document.documentElement && cp.set(t, Vn(t, r)),
  ...
  return (
    ...
    () => {
      ...
      (sp.delete(t),
        n &&
          (fp(t).removeEventListener(`scroll`, n),
          cp.get(t)?.(),
          f.removeEventListener(`resize`, n)));
      let r = dp.get(t);
      (r && (z(r), dp.delete(t)), up.delete(t));
    }
  );
}
function go(e) {
  return f === void 0 ? !1 : e ? jl() : Al();
}
function _o(e) {
...
function bo(e) {
  ...
  for (let [t, n] of pp) if (yo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function xo(e) {
  let t = { value: 0 };
  return {
...
function ko(e, t) {
  return f === void 0 ? !1 : e ? jl() && !!bo(t) : Al();
}
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if (
          (ee > 0 && yt(u, ee), c.length === 1 && c.unshift(null), m && `${m}${bp}`, m && m < bp)
        ) {
          let e = b > 0 ? _ / b : 0;
          b = qo(b, m, _);
          let t = [...c],
          ...
          i &&
            ((a = [...t].reverse()),
            h === `reverse` &&
              (o = [...r].reverse().map((e) => (typeof e == `function` ? qs(e) : e))));
          for (let s = 0; s < m; s++) {
            let l = i && s % 2 == 0,
              d = l ? a : t,
              f = l ? o : r,
  ...
  return (
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        (c[0] !== 0 && (c.unshift(0), s.unshift(s[0]), l.unshift(yp)),
...
function is(e) {
  let t = {
    ...
    n = Pn(e) && !Un(e) ? new bd(t) : new pd(t);
  (n.mount(e), Yu.set(e, n));
}
function as(e) {
  let t = new md({
    presenceContext: null,
...
function fs(e) {
  return typeof e == `object` && !!e && bf in e;
}
function ps(e) {
  if (fs(e)) return e[bf];
}
...
function Ss({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: a, ...o }, s) {
  let l = M(() => Zf[t]),
    u = [],
    d = i(!1),
    f = i(null),
    p = {
      ...
      registerItem: (e, t) => {
        ...
        (r === -1 ? u.push({ value: e, layout: t[n] }) : (u[r].layout = t[n]), u.sort(Cs));
      },
      updateOrder: (e, t, n) => {
        if (d.current) return;
        let i = xs(u, e, t, n);
  ...
  return m(l, {
    ...
    ref: h,
    ignoreStrict: !0,
    children: m(Op.Provider, { value: p, children: e }),
  });
}
function Cs(e, t) {
...
function ws() {
  if (Fp) {
    let e = Es(Fp, `y`);
    e && (Pp.delete(e), Np.delete(e));
    let t = Es(Fp, `x`);
    (t && t !== e && (Pp.delete(t), Np.delete(t)), (Fp = null));
  }
}
function Ts(e, t) {
...
function Ds(e, t, n) {
  ...
  if (o < Ap) {
    let e = 1 - o / Ap;
    return { amount: -jp * e * e, edge: `start` };
  } else if (s < Ap) {
    let e = 1 - s / Ap;
    return { amount: jp * e * e, edge: `end` };
  }
...
function Os(e, t, n, r) {
  ...
  let i = Es(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Ds(t - (n === `x` ? f.scrollX : f.scrollY), i, n);
  if (o === null) {
    (Pp.delete(i), Np.delete(i));
    return;
  }
  let s = Pp.get(i),
  ...
  return m(l, {
    ...
    onDrag: (e, t) => {
      let { velocity: r, point: a } = t,
        o = d[p].get();
      (g(n, o, r[p]), Os(_.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (ws(), a && a(e, t));
    },
...
var js,
  ...
  Lp = t(() => {
    (o(),
      ...
      (P = {}),
      (Fs = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e)),
      (Is = (e) => typeof e == `object` && !!e),
      (Ls = (e) => /^0[^.\s]+$/u.test(e)),
      (F = (e) => e),
      (Rs = (...e) => e.reduce((e, t) => (n) => t(e(n)))),
      (zs = (e, t, n) => {
        let r = t - e;
        return r ? (n - e) / r : 1;
      }),
      ...
      (cc = (e) => {
        if (ac(e)) {
          ...
          let [t, n, r, i] = e;
          return Ie(t, n, r, i);
        } else if (sc(e)) return (oc[e], `${e}`, oc[e]);
        return e;
      }),
      (lc = [
        `setup`,
      ...
      (kc = { test: wc(`#`), parse: Ue, transform: Oc.transform }),
      (Ac = (e) => ({
      ...
      (jc = Ac(`vh`)),
      (Mc = Ac(`vw`)),
      (Nc = { ...U, parse: (e) => U.parse(e) / 100, transform: (e) => U.transform(e * 100) }),
      (Pc = {
        test: wc(`hsl`, `hue`),
      ...
      (G = {
        test: (e) => Oc.test(e) || kc.test(e) || Pc.test(e),
        parse: (e) => (Oc.test(e) ? Oc.parse(e) : Pc.test(e) ? Pc.parse(e) : kc.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? Oc.transform(e) : Pc.transform(e),
        getAnimatableNone: (e) => {
          let t = G.parse(e);
      ...
      (Hc = (e) => (typeof e == `number` ? 0 : G.test(e) ? G.getAnimatableNone(e) : e)),
      (Uc = (e, t) => (typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : Hc(e))),
      ...
      (qc = (e, t) => {
        ...
        let i = { ...n };
        return (e) => (
          (i.red = Wc(n.red, r.red, e)),
          (i.green = Wc(n.green, r.green, e)),
          (i.blue = Wc(n.blue, r.blue, e)),
      ...
      (al = { decay: gt, inertia: gt, tween: Ct, keyframes: Ct, spring: mt }),
      (ol = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (cl = class extends ol {
        ...
        initAnimation() {
          ...
          s !== Ct &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Rs(sl, ot(o[0], o[1]))), (o = [0, 100]));
        ...
        play() {
          ...
          let { driver: e = il, startTime: t } = this.options;
      ...
      (dl = {
        ...
        rotate: ul,
        rotateZ: ul,
        skewX: (e) => ll(Math.atan(e[1])),
        skewY: (e) => ll(Math.atan(e[2])),
        skew: (e) => (Math.abs(e[1]) + Math.abs(e[2])) / 2,
      }),
      (fl = (e) => ((e %= 360), e < 0 && (e += 360), e)),
      (pl = ul),
      (ml = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1])),
      (hl = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5])),
      (gl = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: hl,
        scale: (e) => (ml(e) + hl(e)) / 2,
        rotateX: (e) => fl(ll(Math.atan2(e[6], e[5]))),
        rotateY: (e) => fl(ll(Math.atan2(-e[2], e[0]))),
        rotateZ: pl,
        rotate: pl,
        skewX: (e) => ll(Math.atan(e[4])),
        skewY: (e) => ll(Math.atan(e[1])),
      ...
      (yl = new Set([...vl, `pathRotation`])),
      (bl = (e) => e === vc || e === W),
      (xl = new Set([`x`, `y`, `z`])),
      (Sl = vl.filter((e) => !xl.has(e))),
      (Y = {
      ...
      (Dl = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Cl.add(this), wl || ((wl = !0), R.read(Nt), R.resolveKeyframes(Mt)))
        ...
        cancel() {
          this.state === `scheduled` && (Cl.delete(this), (this.state = `pending`));
        }
        resume() {
      ...
      (Ol = (e) => e.startsWith(`--`)),
      (kl = {}),
      (Al = It(() => f.ScrollTimeline !== void 0, `scrollTimeline`)),
      (jl = It(() => f.ViewTimeline !== void 0, `viewTimeline`)),
      (Ml = It(() => {
        try {
      ...
      (Nl = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`),
      (Pl = {
        linear: `linear`,
        ease: `ease`,
        easeIn: `ease-in`,
      ...
      (Il = { anticipate: Zs, backInOut: Xs, circInOut: ec }),
      (Ll = 10),
      (Rl = class extends Fl {
        constructor(e) {
          (Ht(e),
        ...
        updateMotionValue(e) {
          ...
          let o = new cl({ ...a, autoplay: !1 }),
            s = Math.max(Ll, V.now() - this.startTime),
            c = N(0, Ll, s - Ll),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && Ft(i, u, l),
      ...
      (Bl = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/),
      (Vl = new Set([
        `color`,
        `backgroundColor`,
        `outlineColor`,
      ...
      (Hl = Pe(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Ul = (e, t) =>
        t !== `zIndex` &&
        !!(
          typeof e == `number` ||
      ...
      (Gl = class extends ol {
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          let d = {
              startTime: r
                ? this.resolvedAt && this.resolvedAt - this.createdAt > Wl
                  ? this.resolvedAt
                  : this.createdAt
                : void 0,
              finalKeyframe: t,
      ...
      (Zl = class {
        ...
        getVelocity() {
          let e = V.now();
          if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > Jl)
            return 0;
          let t = Math.min(this.updatedAt - this.prevUpdatedAt, Jl);
          return Vs(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
        }
        start(e) {
          return (
            this.stop(),
      ...
      (nu = (e, { keyframes: t }) =>
        t.length > 2 ? eu : yl.has(e) ? (e.startsWith(`scale`) ? $l(t[1]) : Ql) : tu),
      (ru = new Set([
        `when`,
        `delay`,
        `delayChildren`,
      ...
      (iu =
        ...
        (o) => {
          ...
          return s.isSync ? new cl(u) : new Gl(u);
        }),
      (au = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u),
      (ou = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...vl])),
      (su = (e) => Array.isArray(e)),
      (X = (e) => !!(e && e.getVelocity)),
      (cu = `framerAppearId`),
      (lu = `data-` + un(cu)),
      (uu = (e) => (t) => t.test(e)),
      (du = [vc, W, U, H, Mc, jc, { test: (e) => e === `auto`, parse: (e) => e }]),
      (fu = (e) => du.find(uu(e))),
      (pu = {
        rotate: H,
        pathRotation: H,
      ...
      (gu = new Set([`brightness`, `contrast`, `saturate`, `opacity`])),
      (_u = /\b([a-z-]*)\(.*?\)/gu),
      (vu = {
        ...K,
        getAnimatableNone: (e) => {
      ...
      [...Tu],
      (Eu = (e, t) => (t && typeof e == `number` ? t.transform(e) : e)),
      ({ schedule: Du, cancel: Ou } = ze(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      (ku = (e, t) => (t ? e === t || ku(e, t.parentElement) : !1)),
      (Au = (e) =>
        e.pointerType === `mouse`
          ? typeof e.button != `number` || e.button <= 0
          : e.isPrimary !== !1),
      (ju = new Set([`BUTTON`, `INPUT`, `SELECT`, `TEXTAREA`, `A`])),
      (Mu = new Set([`INPUT`, `SELECT`, `TEXTAREA`])),
      (Nu = new WeakSet()),
      (Pu = (e, t) => {
      ...
      (zu = Ru(`inline`, `width`, `offsetWidth`)),
      (Bu = Ru(`block`, `height`, `offsetHeight`)),
      (Vu = new Set()),
      (Uu = { value: null, addProjectionMetrics: null }),
      (Wu = [...du, G, K]),
      (Gu = (e) => Wu.find(uu(e))),
      (Ku = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 })),
      (qu = () => ({ x: Ku(), y: Ku() })),
      (Ju = () => ({ min: 0, max: 0 })),
      (Q = () => ({ x: Ju(), y: Ju() })),
      (Yu = new WeakMap()),
      ...
      (rd = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : ($u.current || rr(), (this.shouldReduceMotion = Qu.current)),
        ...
        bindToMotionValue(e, t) {
          if (
            ...
            t.accelerate && zl.has(e) && this.current instanceof HTMLElement)
          ) {
        ...
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (Fs(n) || Ls(n))
                ? (n = parseFloat(n))
                : !Gu(n) && K.test(t) && (n = vn(e, t)),
      ...
      (pd = class extends id {
        ...
        readValueFromInstance(e, t) {
          if (yl.has(t)) return this.projection?.isProjecting ? Ot(t) : _l(e, t);
          {
            let n = jr(e),
      ...
      (hd = { offset: `stroke-dashoffset`, array: `stroke-dasharray` }),
      (gd = { offset: `strokeDashoffset`, array: `strokeDasharray` }),
      (_d = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`]),
      (vd = new Set([
        `baseFrequency`,
        `diffuseConstant`,
        `kernelMatrix`,
      ...
      (yd = (e) => typeof e == `string` && e.toLowerCase() === `svg`),
      (bd = class extends id {
        constructor() {
          (super(...arguments),
            (this.type = `svg`),
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = vd.has(t) ? t : un(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Ir(e, t, n);
        }
        ...
        mount(e) {
          ((this.isSVGTag = yd(e.tagName)), super.mount(e));
        }
      }),
      (xd = Zu.length),
      (Sd = [...Xu].reverse()),
      ...
      (Pd = (e) => typeof e == `number` || W.test(e)),
      (Fd = mi(0, 0.5, $s)),
      (Id = mi(0.5, 0.95, F)),
      (Ld = (e, t) => e.depth - t.depth),
      (Rd = class {
        constructor() {
        ...
        forEach(e) {
          (this.isDirty && this.children.sort(Ld), (this.isDirty = !1), this.children.forEach(e));
        }
      }),
      (zd = class {
        constructor() {
      ...
      (Kd = (e) => s !== void 0 && s.userAgent && s.userAgent.toLowerCase().includes(e)),
      (qd = Kd(`applewebkit/`) && !Kd(`chrome/`) ? Math.round : F),
      (Jd = xi({
      ...
      (Yd = (e) => !e.isLayoutDirty && e.willUpdate(!1)),
      (Xd = { current: void 0 }),
      (Zd = xi({
        ...
        defaultParent: () => {
          if (!Xd.current) {
            let e = new Jd({});
            (e.mount(f), e.setOptions({ layoutScroll: !0 }), (Xd.current = e));
          }
          return Xd.current;
        },
        resetTransform: (e, t) => {
      ...
      ($d = ({
        ...
        return (
          ...
          m(Ps.Provider, { value: y, children: e })
        );
      }),
      (ef = (e) => e.key || ``),
      (tf = ({
      ...
      (rf = (e) => e === !0),
      (af = (e) => rf(e === !0) || e === `id`),
      (of = ({ children: e, id: t, inherit: r = !0 }) => {
        let a = y(js),
          o = y(nf),
          [s, c] = ea(),
          l = i(null),
        ...
        l.current === null &&
          (af(r) && u && (t = t ? u + `-` + t : u),
          (l.current = { id: t, group: (rf(r) && a.group) || Gi() }));
        let d = n(() => ({ ...l.current, forceRender: s }), [c]);
        return m(js.Provider, { value: d, children: e });
      }),
      (sf = a({ strict: !1 })),
      (cf = {
        animation: [
    ...
    ((ff = a({})),
      ...
      (mf = a({})),
      (hf = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} })),
      (gf = () => ({ ...hf(), attrs: {} })),
      (_f = [
        `animate`,
        `circle`,
      ...
      (vf = pf({ scrapeMotionValuesFromProps: Ar, createRenderState: hf })),
      (yf = pf({ scrapeMotionValuesFromProps: Ir, createRenderState: gf })),
      (bf = Symbol.for(`motionComponentSymbol`)),
      (xf = class extends ad {
        constructor(e) {
      ...
      (Cf = class extends ad {
        constructor() {
          (super(...arguments), (this.id = Sf++), (this.isExitComplete = !1));
        }
        update() {
      ...
      (wf = { animation: { Feature: xf }, exit: { Feature: Cf } }),
      (Tf = (e) => (t) => Au(t) && e(t, Aa(t))),
      (Ef = (e, t) => Math.abs(e - t)),
      (Df = (e, t) => ((t.isSVG ?? va(e)) ? new bd(t) : new pd(t, { allowProjection: e !== l }))),
      (Of = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
      (kf = new Set([`auto`, `scroll`])),
      (Af = class {
        constructor(
          e,
          t,
        ...
        startScrollTracking(e) {
          ...
          for (; t; ) {
            ...
            ((kf.has(e.overflowX) || kf.has(e.overflowY)) &&
      ...
      (Nf = class {
        ...
        start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
          ...
          this.panSession = new Af(
            ...
            { onSessionStart: i, onStart: a, onMove: o, onSessionEnd: s, resumeAnimation: c },
            {
              ...
              dragSnapToOrigin: l,
              distanceThreshold: n,
              contextWindow: Of(this.visualElement),
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (ln(this.visualElement, e), n.start(iu(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
      ...
      (If = class extends ad {
        ...
        onPointerDown(e) {
          this.session = new Af(e, this.createPanHandlers(), {
            transformPagePoint: this.node.getTransformPagePoint(),
            contextWindow: Of(this.node),
          });
        }
        createPanHandlers() {
      ...
      (zf = { pan: { Feature: If }, drag: { Feature: Pf, ProjectionNode: Zd, MeasureLayout: $a } }),
      (Bf = class extends ad {
        mount() {
        ...
        startObserver() {
          ...
          let { viewport: e = {} } = this.node.getProps(),
            ...
            a = {
              ...
              rootMargin: n,
              threshold: typeof r == `number` ? r : qf[r],
            },
            o = (e) => {
      ...
      (Xf = { layout: { ProjectionNode: Zd, MeasureLayout: $a } }),
      (Zf = ka({ ...wf, ...Yf, ...zf, ...Xf }, Df)),
      (Qf = { renderer: Df, ...wf, ...Yf }),
      { ...Qf, ...zf, ...Xf },
      { ...wf },
      ($f = 50),
      (ep = () => ({
      ...
      (tp = () => ({ time: 0, x: ep(), y: ep() })),
      (np = { x: { length: `Width`, position: `Left` }, y: { length: `Height`, position: `Top` } }),
      ...
      (up = new WeakMap()),
      (dp = new WeakMap()),
      (fp = (e) => (e === document.scrollingElement ? f : e)),
      (pp = [
        [ap.Enter, `entry`],
        [ap.Exit, `exit`],
        [ap.Any, `cover`],
      ...
      (mp = { start: 0, end: 1 }),
      (hp = new Map()),
      (gp = () => ({ scrollX: D(0), scrollY: D(0), scrollXProgress: D(0), scrollYProgress: D(0) })),
      (_p = (e) => (e ? !e.current : !1)),
      (vp = class extends Zl {
        constructor() {
        ...
        add(e) {
          (yl.has(e) || zl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
      ...
      (yp = `easeInOut`),
      (bp = 20),
      (xp = (e) => typeof e == `number`),
      (Sp = (e) => e.every(xp)),
      (Cp = us()),
      (wp = ds),
      (Tp = { some: 0, all: 1 }),
      (Ep = () => ({})),
      pf({ scrapeMotionValuesFromProps: Ep, createRenderState: Ep }),
      (Dp = {}),
      fe(Dp, { Group: () => kp, Item: () => Ip }),
      (Op = a(null)),
      (kp = _(Ss)),
      (Ap = 50),
      (jp = 25),
      (Mp = new Set([`auto`, `scroll`])),
      (Np = new WeakMap()),
      (Pp = new WeakMap()),
      (Fp = null),
      (Ip = _(As)));
...
//# sourceMappingURL=motion.uzrgujnr.mjs.map
